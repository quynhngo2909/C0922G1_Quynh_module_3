...
<div class="row justify-content-center container-fluid bg-light fw-bold fs-4 ">Update user's information</div>
<div>
    <form action="/users?action=update&id=${user.getId()}" method="post">
        <fieldset>
            <legend>User information</legend>
            <table>
                <tr>
                    <td>Name: </td>
                    <td><input name="name" type="text" placeholder="${user.getName()}"></td>
                </tr>
                <tr>
                    <td>Email: </td>
                    <td><input name="email" type="text" placeholder="${user.getEmail()}"></td>
                </tr>
                <tr>
                    <td>Country: </td>
                    <td><input name="country" type="text" placeholder="${user.getCountry()}"></td>
                </tr>
                <tr>
