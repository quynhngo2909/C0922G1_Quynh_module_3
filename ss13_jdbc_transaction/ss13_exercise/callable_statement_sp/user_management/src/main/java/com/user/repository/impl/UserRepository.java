...
public class UserRepository implements IUserRepository {
    ...
    private static final String GET_USER_LIST_SP = "call get_user_list";
    private static final String UPDATE_USER_INFO_SP = "call update_user_info(?,?,?,?)";
    ...
    public List<User> getUserList() {
        ...
        try {
            ...
            CallableStatement cs = connection.prepareCall(GET_USER_LIST_SP);
    ...
    public boolean updateUserSp(User user) {
        ...
        try {
            connection = getConnection();
            CallableStatement cs = connection.prepareCall(UPDATE_USER_INFO_SP);
            cs.setInt(1,user.getId());
            cs.setString(2, user.getName());
            cs.setString(3, user.getEmail());
            cs.setString(4, user.getCountry());
            updateStatus = cs.executeUpdate() > 0;
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
        return updateStatus;
    ...
    public boolean deleteUserSp(int id) {
        ...
        try {
            ...
            cs.setInt(1, id);
             deleteStatus = cs.executeUpdate() > 0;
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
        return deleteStatus;
