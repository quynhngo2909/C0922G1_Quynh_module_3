...
<div class="row d-flex justify-content-between">
    ...
    <div class="col-md-3 dropdown">
        ...
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="/ServiceServlet/action=search&id=1">Villa</a></li>
            <li>
                <hr class="dropdown-divider">
            </li>
            <li><a class="dropdown-item" href="/ServiceServlet/action=search&id=2">House</a></li>
            <li>
                <hr class="dropdown-divider">
            </li>
            <li><a class="dropdown-item" href="/ServiceServlet/action=search&id=3">Room</a></li>
        </ul>
    </div>
    <div class="col-md-6">
    ...
    <form action="/ServiceServlet?action=create&id=1" method="post">
        <fieldset>
            ...
            <table class="table table-hover">
                ...
                <tr>
                    <td><label for="standardRoom">Standard Room/label</label></td>
                    <td>
