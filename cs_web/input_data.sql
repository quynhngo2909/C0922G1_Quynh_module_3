...
insert into employee (name, birthday, id_card, salary, phone_number, email, address, position_id, education_degree_id, division_id) 
	...
	('Nguyễn Bỉnh Phát', '1999-12-09', '454363232', 6000000, '0902341231', 'phatphat@gmail.com', '43 Yên Yái, Đà Nẵng', 2, 1, 1),
...
insert into customer(name, birthday, gender, id_card, phone_number, email, address, customer_type) 
	values
...
insert into contract_detail (quantity, contract_id, attach_facilty_id)
	values
	(5, 2, 4),
	(8, 2, 5),
	(15, 2, 6),
